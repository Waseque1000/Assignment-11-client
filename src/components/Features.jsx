...
import React from "react";
import { Library, Search, Heart, Upload } from "lucide-react";
...
export default function Features() {
  ...
  return (
    <section className="py-16 bg-stone-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-amber-800 dark:text-amber-500 mb-4">
            Discover History's Treasures
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3 text-center">
                  {feature.title}
                </h3>
          ...
          <div className="flex items-center justify-center">
            <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-xl">
              ...
              <img
                src="https://i.ibb.co/RzpMYw1/China-National-Silk-Museum-1-1.jpg"
                alt="Historical artifacts collection"
                className="relative rounded-lg shadow-xl w-full h-auto"
              />
            </div>
